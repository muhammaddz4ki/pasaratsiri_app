...
class _SubsidyManagementScreenState extends State<SubsidyManagementScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<SubsidyApplication>>(
        stream: _governmentService.getSubsidyApplications(),
        builder: (context, snapshot) {
          ...
          if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return const Center(
              child: Text('Tidak ada data pengajuan subsidi.'),
            );
          }
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          children: [
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Text(
                                            'Rp ${_formatPrice(_getTotalDisbursed(allApplications))}',
                                            style: TextStyle(
                                              fontSize: 20,
                                              fontWeight: FontWeight.w700,
                                              color: Colors.blue[700],
                            ...
                            ...filteredApplications.asMap().entries.map((
                              entry,
                            ) {
  ...
  int _getTotalDisbursed(List<SubsidyApplication> applications) {
    return applications
        .where((app) => app.status == 'Disalurkan')
        .fold(0, (sum, app) => sum + app.subsidyAmount);
  }
  ...
  void _showApplicationDetails(SubsidyApplication application) {
  ...
  void _processApplication(SubsidyApplication application) {
    showDialog(
      context: context,
  ...
  void _updateApplicationStatus(String id, String newStatus) async {
    await _governmentService.updateSubsidyStatus(id, newStatus);
