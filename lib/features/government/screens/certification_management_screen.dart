...
class _CertificationManagementScreenState
  ...
  final List<Map<String, dynamic>> _certificationApplications = [
    {
      'id': 'CERT001',
      'applicantName': 'Budi Santoso',
      'applicantType': 'Petani',
      'certificationType': 'Sertifikasi Organik',
      'submissionDate': '2025-01-28',
      'status': 'Pending',
      'documents': ['KTP', 'Surat Lahan', 'Foto Kebun'],
    ...
    {
      'id': 'CERT002',
      'applicantName': 'CV. Atsiri Garut',
      'applicantType': 'UMKM',
      'certificationType': 'Sertifikasi Mutu',
      'submissionDate': '2025-01-25',
      'status': 'Disetujui',
      'documents': ['SIUP', 'NIB', 'Sertifikat Analisa Lab'],
      'location': 'Kec. Pasirwangi',
      'phoneNumber': '081987654321',
      'email': 'info@atsiri-garut.co.id',
    },
    {
      'id': 'CERT003',
      'applicantName': 'Ahmad Hidayat',
      'applicantType': 'Petani',
      'certificationType': 'Sertifikasi GAP',
      'submissionDate': '2025-01-20',
      'status': 'Ditolak',
      'documents': ['KTP', 'Surat Lahan'],
      'location': 'Kec. Leles',
                ...
                children: [
                  Expanded(
                    child: _buildEnhancedStatCard(
                      'Total',
                      _certificationApplications.length.toString(),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        'Diajukan: ${application['submissionDate']}',
                                        style: const TextStyle(
                                          fontSize: 11,
                                          fontWeight: FontWeight.w500,
                                          color: Color(0xFF64748B),
  ...
  void _updateStatus(String id, String newStatus) {
    setState(() {
      int index = _certificationApplications.indexWhere(
        (app) => app['id'] == id,
      );
      if (index != -1) {
        _certificationApplications[index]['status'] = newStatus;
      }
    });
